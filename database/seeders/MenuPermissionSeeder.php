        ...
        return [
            ...
            [
                ...
                'permissions' => [
                    ...
                    ['name' => 'admin.interns.edit', 'label' => 'Edit / Assign Mentor'],
                    ['name' => 'admin.interns.update', 'label' => 'Update Data'],
            ...
            [
                'title' => 'Jobdesk / Task',
                'route_name' => null, // Has submenus for roles later, but we can set a generic one or use null
                'icon' => 'ri-task-line',
                'permissions' => [
                    ['name' => 'intern.tasks.index', 'label' => 'Intern Read Own Tasks'],
                    ['name' => 'intern.tasks.show', 'label' => 'Intern Show Task Detail'],
                    ['name' => 'intern.tasks.update-status', 'label' => 'Intern Update Task Status'],
                    ['name' => 'mentor.tasks.index', 'label' => 'Mentor Read Assigned Tasks'],
                    ['name' => 'mentor.tasks.create', 'label' => 'Mentor Create Task'],
                    ['name' => 'mentor.tasks.store', 'label' => 'Mentor Save Task'],
                    ['name' => 'mentor.tasks.show', 'label' => 'Mentor Show Task'],
                    ['name' => 'mentor.tasks.edit', 'label' => 'Mentor Edit Task'],
                    ['name' => 'mentor.tasks.update', 'label' => 'Mentor Update Task'],
                    ['name' => 'mentor.tasks.destroy', 'label' => 'Mentor Delete Task'],
                    ['name' => 'admin.tasks.index', 'label' => 'Admin Read Tasks'],
                    ['name' => 'admin.tasks.create', 'label' => 'Admin Create Task'],
                    ['name' => 'admin.tasks.store', 'label' => 'Admin Save Task'],
                    ['name' => 'admin.tasks.show', 'label' => 'Admin Show Task'],
                    ['name' => 'admin.tasks.edit', 'label' => 'Admin Edit Task'],
                    ['name' => 'admin.tasks.update', 'label' => 'Admin Update Task'],
                    ['name' => 'admin.tasks.destroy', 'label' => 'Admin Delete Task'],
                ],
            ],
            [

...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-1">Tambah Role Baru</h4>
        ...
        <form action="{{ route('roles.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="roleName" name="name" class="form-control" 
                    placeholder="Contoh: manager" value="{{ old('name') }}" required />
                            ...
                            <td class="text-center">
                                <div class="form-check form-switch d-flex justify-content-center mb-0">
                                    <input class="form-check-input perm-toggle" type="checkbox" 
                                        ...
                                        @checked(collect(old('permissions'))->contains($permission->name)) />
                                </div>
                            </td>
                        </tr>
                        @endforeach
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateGlobalSelectAll() {
        selectAll.checked = Array.from(permToggles).every(t => t.checked);
    }
});
</script>
@endsection

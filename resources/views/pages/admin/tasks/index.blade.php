...
<div class="card">
  <div class="card-header d-flex justify-content-between align-items-center">
    ...
    <a href="{{ route('admin.tasks.create') }}" class="btn btn-primary"><i class="ri-add-line me-1"></i> Buat Tugas Baru</a>
  </div>
          ...
          <td>
            <div class="dropdown">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route('admin.tasks.show', $task->id) }}"><i class="ri-eye-line me-1"></i> Detail</a>
                <a class="dropdown-item" href="{{ route('admin.tasks.edit', $task->id) }}"><i class="ri-pencil-line me-1"></i> Edit</a>
                <form action="{{ route('admin.tasks.destroy', $task->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus tugas ini?');">
                  @csrf
                  @method('DELETE')

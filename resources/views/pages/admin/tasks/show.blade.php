  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('admin.tasks.index') }}" class="btn btn-outline-secondary btn-sm">Kembali</a>
      </div>
      <div class="card-body">
        <div class="row mb-3">
        ...
        <div class=\"mt-4 pt-3 border-top d-flex gap-2\">
            <a href=\"{{ route('admin.tasks.edit', \$task->id) }}\" class=\"btn btn-primary\"><i class=\"ri-pencil-line me-1\"></i> Edit Tugas</a>
